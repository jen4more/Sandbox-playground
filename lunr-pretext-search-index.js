...
},
{
  ...
  "body": " PROTEUS exercises  In part , you explored the velocity of a ball at various times. Answer the following questions to explore other rates of change.   For each of the following scenarios, specify the input and the output and possible units for both the input and the output. Then give units for the rate of change.    The population of a city changes over time.   Input:     Output:     Rate of change:        As a weather balloon rises, the temperature of the air inside (and outside) the balloon decreases.   Input:     Output:     Rate of change:        For a given trip (i.e. a set distance) as the speed of the car increases, the travel time decreases.   Input:     Output:     Rate of change:        As the population of a city decreases, the tax revenue of the city also decreases.   Input:     Output:     Rate of change:          Give your own example of a quantity that changes over time, the units of the input and output, and the units of the rate of change.    "
},
{
  ...
  "number": "1.2.1",
  "title": "",
  "body": " For each of the following scenarios, specify the input and the output and possible units for both the input and the output. Then give units for the rate of change.    The population of a city changes over time.   Input:     Output:     Rate of change:        As a weather balloon rises, the temperature of the air inside (and outside) the balloon decreases.   Input:     Output:     Rate of change:        For a given trip (i.e. a set distance) as the speed of the car increases, the travel time decreases.   Input:     Output:     Rate of change:        As the population of a city decreases, the tax revenue of the city also decreases.   Input:     Output:     Rate of change:        "
},
{
  ...
  "number": "1.2.2",
  "title": "",
  "body": " Give your own example of a quantity that changes over time, the units of the input and output, and the units of the rate of change.   "
},
{
  "id": "backmatter-2",
  "level": "1",
